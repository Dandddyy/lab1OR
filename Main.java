...
class SliderExampleGUI {
    ...
    private void addListeners() {
        ...
        startBothButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                thread1 = new Threads(slider, priority1, 10);
                thread2 = new Threads(slider, priority2, 90);
        ...
        startButton1.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                if (semaphore == 0) {
                    semaphore = 1;
                    thread1 = new Threads(slider, Thread.MIN_PRIORITY, 10);
                    thread1.start();
                    startButton1.setEnabled(false);
                    startBothButton.setEnabled(false);
        ...
        startButton2.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                if (semaphore == 0) {
                    semaphore = 2;
                    thread2 = new Threads(slider, Thread.MAX_PRIORITY, 90);
                    thread2.start();
                    startButton2.setEnabled(false);
                    startBothButton.setEnabled(false);
                    stopBothButton.setEnabled(false);
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                SliderExampleGUI gui = new SliderExampleGUI();
                gui.display();
            }
        });
    }
...
class Threads extends Thread {
    ...
    public Threads(JSlider slider, int priority, int val) {
        this.slider = slider;
